...
from ..vis import colour, Table, ColSpec, L, R, Align
from ..vis.cols import Colour, \
...
@command(
    argument('--term-sentinel', dest='terminal_sentinel',
             metavar=TERMINAL_SENTINEL_SYMBOL, type=str,
             default=TERMINAL_SENTINEL_SYMBOL,
             help=f'Symbol to use for the terminal sentinel.'),
    argument('--central-sentinel', dest='central_sentinel',
             metavar=CENTRAL_SENTINEL_SYMBOL, type=str,
             default=CENTRAL_SENTINEL_SYMBOL,
             help=f'Symbol to use for the central sentinel.'),
    argument('--interactive',
             action=argparse.BooleanOptionalAction,
             default=True,
             help="The visualisation should pause between steps."),

    argument('x', metavar='string', type=str,
             help='string to build the suffix array from.'),
    parent=show.subparsers
)
def skew(args: argparse.Namespace) -> None:
    """Display a run of the skew algorithm."""
