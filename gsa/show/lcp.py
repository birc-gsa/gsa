...
from ..vis.cols import bright_cyan, bright_green, bright_yellow, \
    bright_red, ansifree_len, green, red, underline
from ..vis import colour, place_pointers, Table, ColSpec, Align
...
def lcp(args: argparse.Namespace) -> None:
    """Display run of algorithm for constructing the lcp from the sa."""
    sa = sais.sais(args.x)
